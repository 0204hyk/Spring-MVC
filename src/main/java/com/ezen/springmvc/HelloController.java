...
public class HelloController {
	...
	@RequestMapping("log")
	String log() {
		// 2. 원하는 로그를 Logger에 추가하기 (로그 메세지마다 등급을 설정할 수 있다.)
		...
		// src/main/resources/log4j.xml 파일 내에서
		// Application Logger을 debug로 설정해놨기 때문에 debug 이상 등급의 로그가 다 나온다. (Root Logger보다 우선)
